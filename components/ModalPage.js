...
const style = {
  body: `flex-shrink flex-grow px-4 py-1  `,
  headerTitle: `text-sm font-bold text-blue-600 text-center`,
  header: `items-start justify-between px-4 py-1 border-b border-gray-300 `,
  container: `fixed top-0 overflow-y-auto left-0 z-40 w-full h-full m-0 opacity-90`,
  overlay: `fixed top-0 left-0 z-30 w-screen h-screen bg-black opacity-50 `,
  content: `animate-modal relative flex flex-col bg-white pointer-events-auto rounded bg-gray-400`,
  footer: `flex flex-wrap items-center justify-end px-3 py-1 border-t border-gray-300`,
